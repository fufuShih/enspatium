...
docker build --target server -t felixshih/enspatium-server:v0.2.1 .
docker build --target web -t felixshih/enspatium-web:v0.2.1 .
docker push felixshih/enspatium-server:v0.2.1
docker push felixshih/enspatium-web:v0.2.1
```
